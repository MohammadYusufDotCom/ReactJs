...
function Header() {
  ...
  return (
   ...
   <header className="sticky top-0 w-full h-20 backdrop-blur-sm bg-opacity-35 bg-green-900 ">
    ...
    <div className=" ">
      <Link to={"/"} className={`font-extrabold text-3xl font-sans cursor-pointer text-blue-50`}>
    ...
    <ul className=" flex order-2 lg:gap-11 sm:gap-7 text-white"> 
      <li><NavLink to={'/'} className={({isActive})=>`px-2 py-0.5 ${isActive?'text-green-500 ':'text-white'}`}>Home </NavLink></li>
      <li><NavLink to={'product'} className={({isActive})=>`px-2 py-0.5 ${isActive?'text-green-500 ':'text-white'}`}>Product</NavLink></li>
      <li><NavLink to={'profile'} className={({isActive})=>`px-2 py-0.5 ${isActive?'text-green-500 ':'text-white'}`}>Profile</NavLink></li>
      <li><NavLink to={'about'} className={({isActive})=>`px-2 py-0.5 ${isActive?'text-green-500 ':'text-white'}`}>About</NavLink></li>
      <li><NavLink to={'cart'} className={({isActive})=>`px-2 py-0.5 ${isActive?'text-green-500 ':'text-white'}`}>Cart</NavLink></li>
    </ul>
    </nav>
   </header>
